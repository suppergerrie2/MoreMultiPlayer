...
namespace MoreMultiPlayer
{
    ...
    static class SteamManagerPatch_HostGame
    {
        ...
        {
            Plugin.Log.LogInfo("Running custom HostGame patch");
            ...
            Plugin.Log.LogInfo("My SteamID: " + SteamClient.SteamId);
            ...
            {
                Plugin.Log.LogInfo($"{i} <? {__instance.connectedPlayers.Count}");
            ...
            Plugin.Log.LogInfo(SteamManagerExtended.startParameters.ToString());
    ...
    static class SteamManagerPatch_ForceLoadNextLevel
    {
        ...
        {
            Plugin.Log.LogInfo("Running custom ForceLoadNextLevel patch");
    ...
    static class SteamManagerPatch_InitNetworkClient
    {
        ...
        {
            Plugin.Log.LogInfo("Running custom InitNetworkClient patch");
    ...
    static class SteamManagerPatch_HostNextLevel
    {
        ...
        {
            Plugin.Log.LogInfo("Running custom HostNextLevel patch");
